...
public struct Theme: Sendable {
    ...
    public let lightBorder: Color
    public let disabled: Color
    public let eventCellBackground: Color
    public let highlightWarm1: Color
    public let highlightWarm2: Color
    public let highlightNeutral: Color
    public let highlightCool1: Color
    ...
    public static func highlightColor(for text: String) -> String {
        let options: [Color] = [
