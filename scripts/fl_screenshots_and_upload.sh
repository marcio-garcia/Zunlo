...
LOG_FILE="$PROJECT_DIR/logs/fastlane/screenshots_and_upload_${ENV_ARG}_${TIMESTAMP}.log"

echo "===========================================" | tee "$LOG_FILE"
echo "Fastlane Lane: screenshots_and_upload" | tee -a "$LOG_FILE"
...
# Run fastlane lane
cd "$PROJECT_DIR" && fastlane screenshots_and_upload 2>&1 | tee -a "$LOG_FILE"
