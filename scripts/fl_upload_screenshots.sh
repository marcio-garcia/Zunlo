...
LOG_FILE="$PROJECT_DIR/logs/fastlane/upload_screenshots_${ENV_ARG}_${TIMESTAMP}.log"

echo "===========================================" | tee "$LOG_FILE"
echo "Fastlane Lane: upload_screenshots" | tee -a "$LOG_FILE"
...
# Run fastlane lane
cd "$PROJECT_DIR" && fastlane upload_screenshots 2>&1 | tee -a "$LOG_FILE"
