...
LOG_FILE="$PROJECT_DIR/logs/fastlane/prepare_app_store_${ENV_ARG}_${TIMESTAMP}.log"

echo "===========================================" | tee "$LOG_FILE"
echo "Fastlane Lane: prepare_app_store" | tee -a "$LOG_FILE"
...
# Run fastlane lane
cd "$PROJECT_DIR" && fastlane prepare_app_store 2>&1 | tee -a "$LOG_FILE"
