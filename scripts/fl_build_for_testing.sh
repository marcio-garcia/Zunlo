...
LOG_FILE="$PROJECT_DIR/logs/fastlane/build_for_testing_${ENV_ARG}_${TIMESTAMP}.log"

echo "===========================================" | tee "$LOG_FILE"
echo "Fastlane Lane: build_for_testing" | tee -a "$LOG_FILE"
...
# Run fastlane lane
cd "$PROJECT_DIR" && fastlane build_for_testing 2>&1 | tee -a "$LOG_FILE"
